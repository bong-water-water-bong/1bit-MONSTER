...
// Override with NPU_XCLBIN_DIR=/path/to/xclbins to point at another model's
// xclbin set (each dir must contain mm/attn/layer/dequant .xclbin + .bin insts).
// The insts file for <name>.xclbin is <name>.bin in the same directory,
// generated by tools/gen_mm_insts (FastFlowLM Gemm::generate_seq).
static const char* XCLBIN_PATHS[XCLBIN_COUNT] = {
    "/home/bcloud/amd-oss/fastflowlm/src/xclbins/Qwen3-0.6B-NPU2/mm.xclbin",
    "/home/bcloud/amd-oss/fastflowlm/src/xclbins/Qwen3-0.6B-NPU2/attn.xclbin",
    "/home/bcloud/amd-oss/fastflowlm/src/xclbins/Qwen3-0.6B-NPU2/layer.xclbin",
    "/home/bcloud/amd-oss/fastflowlm/src/xclbins/Qwen3-0.6B-NPU2/dequant.xclbin",
};

// NPU kernel argument indices
typedef enum {
    KERN_ARG_OPCODE = 0,    // uint32_t
    KERN_ARG_INSTR_PTR,     // uint64_t: insts BO (REQUIRED — see XclbinManager)
    KERN_ARG_NINSTR,        // uint32_t: insts count in words (REQUIRED)
