...
B=/tmp/llvm-aie-src/build-peano/bin
LLCXX=/tmp/llvm-aie-src/libcxx/include
LLGEN=/tmp/llvm-aie-src/build-peano/libcxx-gen/include
LLCFG=/tmp/llvm-aie-src/build-peano/include/aie2p-none-unknown-elf/c++/v1
INC="-isystem $LLCXX -isystem $LLGEN -isystem $LLCFG -isystem $P/include/aie2p-none-unknown-elf -I $M/include -I $M/include/aie_kernels/aie2p -I /home/bcloud/Xilinx/2025.2/Vitis/aietools/include"
$B/clang --target=aie2p-none-unknown-elf --std=c++20 -O2 \
    -DDIM_M=8 -DDIM_K=64 -DDIM_N=128 -Di8_i32_ONLY -DM8_VECTORIZED -DNPU_C1_DUMP -Wno-c++11-narrowing $INC \
    -c "$G/mm_kernel_reference.cc" -o "$W/mm.o" 2>/dev/null
$B/clang --target=aie2p-none-unknown-elf --std=c++20 -O2 \
    -DDIM_M=8 -DDIM_K=64 -DDIM_N=128 -Di8_i32_ONLY -DM8_VECTORIZED -Wno-c++11-narrowing $INC \
    -c "$G/attn_kernel_reference.cc" -o "$W/silu.o" 2>/dev/null
$B/clang --target=aie2p-none-unknown-elf --std=c++20 -O2 -Wno-c++11-narrowing $INC \
